...
CREATE TABLE IF NOT EXISTS `recuperalo`.`articles` (
  ...
  `event_articles` VARCHAR(100) NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
...
-- -----------------------------------------------------
-- Table `recuperalo`.`pets`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `recuperalo`.`pets` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `id_register_qr` INT NOT NULL COMMENT '',
  `id_users` INT NOT NULL COMMENT '',
  `type_pet` VARCHAR(50) NULL COMMENT '',
  `name_pet` VARCHAR(100) NULL COMMENT '',
  `breed_pet` VARCHAR(100) NULL COMMENT '',
  `color_pet` VARCHAR(100) NULL COMMENT '',
  `size_pet` VARCHAR(100) NULL COMMENT '',
  `description_pet` VARCHAR(100) NULL COMMENT '',
  `age_pet` INT NULL COMMENT '',
  `name_vet` VARCHAR(45) NULL COMMENT '',
  `phone_vet` INT NULL COMMENT '',
  `microchip_pet` VARCHAR(45) NULL COMMENT '',
  `img_pet` LONGTEXT NULL COMMENT '',
  `reward` FLOAT NULL COMMENT '',
  `registration_date` DATETIME NOT NULL COMMENT '',
  `birthday_pet` DATE NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `fk_pets_users1_idx` (`id_users` ASC)  COMMENT '',
  INDEX `fk_pets_register_qr1_idx` (`id_register_qr` ASC)  COMMENT '',
  CONSTRAINT `fk_pets_users1`
    FOREIGN KEY (`id_users`)
    REFERENCES `recuperalo`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pets_register_qr1`
    FOREIGN KEY (`id_register_qr`)
    REFERENCES `recuperalo`.`register_qr` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `recuperalo`.`location_pets`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `recuperalo`.`location_pets` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `id_pets` INT NOT NULL COMMENT '',
  `longitude` VARCHAR(45) NULL COMMENT '',
  `latitude` VARCHAR(45) NULL COMMENT '',
  `addres` VARCHAR(45) NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `fk_location_pets_pets1_idx` (`id_pets` ASC)  COMMENT '',
  CONSTRAINT `fk_location_pets_pets1`
    FOREIGN KEY (`id_pets`)
    REFERENCES `recuperalo`.`pets` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;


CREATE TABLE IF NOT EXISTS `recuperalo`.`push_notifications` (
